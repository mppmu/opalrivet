...
ClassImp(NtupleReader)

extern "C" {
    void pxlth4_( Int_t*, Int_t*, Float_t*, Float_t*, Float_t*, Int_t* );
};

NtupleReader::NtupleReader() : nt_file(0), nt_tree(0) {}
...
Float_t NtupleReader::costt() { return nt_Tvectc[2]; }
Float_t NtupleReader::tdmt() { return nt_Tdmt; }
