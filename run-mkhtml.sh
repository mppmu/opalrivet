...
sed -i 's@LineStyle=solid@PolyMarker=*@g' $(ls -1 out/$1/d23*.dat  out/$1/d22*.dat out/$1/d21*.dat out/$1/d30*.dat  out/$1/d10*.dat out/$1/d09*.dat out/$1/d08*.dat  out/$1/d07*.dat )
