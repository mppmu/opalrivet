...
sed -i 's@LineStyle=solid@PolyMarker=*@g' $(ls -1 out/$1/d23*.dat  out/$1/d13*.dat out/$1/d12*.dat out/$1/d11*.dat  out/$1/d10*.dat out/$1/d09*.dat out/$1/d08*.dat  out/$1/d07*.dat )
