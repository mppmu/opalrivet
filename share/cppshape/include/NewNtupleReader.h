#ifndef NEWTUPLEREADER_HH
#define NEWNTUPLEREADER_HH
...
class NewNtupleReader : public TObject
{

public:

    NewNtupleReader();
    NewNtupleReader( const char* filename, const char* ntid="h10");
    ~NewNtupleReader();
