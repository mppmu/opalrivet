#ifndef NTUPLE_200_HH
#define NTUPLE_200_HH
...
class ntuple_200 : public Ntuple {
private:
  FInteger _irun;
  FInteger _ievnt;
  FInteger _itkmh;
...
public:
  ...
  virtual FInteger iwqqln() { return _iwqqln; };
  virtual FInteger idqqln() { return _idqqln; };
  virtual FInteger iebal() { return _iebal; };
  virtual FInteger icat() { return _icat; };
  virtual FInteger iminrmp() { return _iminrmp; };
  ...
  virtual FReal lwqqln() { return _lwqqln; };
  virtual FReal lwexef0() { return _lwexef0; };
  virtual FReal lwexef1() { return _lwexef1; };
  ...
  virtual FReal* ptrk() { return _ptrk[0]; };
  ...
  virtual FReal* pclus() { return _pclus[0]; };
