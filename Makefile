...
DX_ENV =  SRCDIR='.' PROJECT='opalrivet' DOCDIR='./doc' VERSION='0.282:289M' PERL_PATH='/usr/bin/perl' HAVE_DOT='NO' GENERATE_MAN='NO' GENERATE_RTF='NO' GENERATE_XML='NO' GENERATE_HTMLHELP='NO' GENERATE_CHI='NO' GENERATE_HTML='NO' GENERATE_LATEX='YES'
DX_FLAG_chi = 0
DX_FLAG_chm = 0
DX_FLAG_doc = 1
DX_FLAG_dot = 0
...
OBJDUMP = objdump
OBJEXT = o
OPALRIVET_API_VERSION = 0.282:289M
...
PACKAGE_STRING = opalrivet 0.282:289M
PACKAGE_TARNAME = opalrivet
PACKAGE_URL = http://mpp.mpg.de
PACKAGE_VERSION = 0.282:289M
PATH_SEPARATOR = :
RANLIB = ranlib
