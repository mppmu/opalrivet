...
\begin{table}[htbp]\centering
\begin{tabular}{|c|c|c|}\hline
Old algorithms        &  Parameters  & Descryption    \\\hline\hline
Durham                &  $R=0.7$     &          \\
Jade                  &  $R=0.7$     &      \\\hline\hline


New cone algorithms   &  Parameters    & \\\hline\hline
Anti-$k_{T}$          &  $R=0.7,P=-1.0$ &       \\
Cambridge-Aachen      &  $R=0.7,P=-1.0$  &             \\
...
Cut on ${\cal L}_{qqll}$    &    $0.50$       & $0.75$  & $0.25$ \\
Cut on ${\cal L}_{qqqq}$    &    $0.25$       &  $0.40$ & $0.1$ \\
Cut on $\cos{\theta}$                         &    $0.9$       &   & $0.7$ \\
${s}^{'}$ reconstruction                     &                &   & \\           
\hline
\end{tabular}
\caption{
