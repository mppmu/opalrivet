...
%\def\cnt{2}
%\advance\cnt by 1
\newcommand{\TABGFONTSIZE}{\scriptsize}
...
\TABGsisconeonethreezeroJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 130\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktonethreezeroJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 130\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconeonethreesixJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 136\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktonethreesixJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 136\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconeonesixoneJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 161\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktonesixoneJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 161\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconeoneseventwoJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 172\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktoneseventwoJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 172\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconeoneeightthreeJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 183\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktoneeightthreeJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 183\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconeoneeightnineJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 189\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktoneeightnineJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 189\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconeoneninetwoJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 192\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktoneninetwoJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 192\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconeoneninesixJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 196\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktoneninesixJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 196\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconetwozerotwoJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 202\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantikttwozerotwoJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 202\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconetwozerofiveJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 205\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantikttwozerofiveJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 205\GeV$. The first uncertainty is statistical and the second is systematical.}
...
\TABGsisconetwozerosevenJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 207\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantikttwozerosevenJETRall{$y$ cut}{The jet rates distributions obtained with Siscone jet clustering algorithm for $\sqrt{s}= 207\GeV$. The first uncertainty is statistical and the second is systematical.}
