...
The tracks with small transverse momenta $p_{T}<0.10\GeV$,{\bf $0.15?\GeV$} the minimal  distance to the 
...
and cluster objects.
To reject from the $e^+e^-\rightarrow W^+W^-$ background events the relevant likelihood-based cuts ${\cal L}_{qqqq}$ and 
${\cal L}_{qqll}$ were applied.
