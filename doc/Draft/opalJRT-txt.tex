...
\TABGdurhamonesixoneJETRall{$y$ cut}{The jet rates distributions obtained with Durham jet clustering algorithm for $\sqrt{s}= 161\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGjadeonesixoneJETRall{$y$ cut}{The jet rates distributions obtained with Jade jet clustering algorithm for $\sqrt{s}= 161\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGsisconezerodotsevenonesixoneJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with SIScone ($R=0.7,O=0.75$) jet clustering algorithm for $\sqrt{s}= 161\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGsisconeonedotzeroonesixoneJETRall{$E$ cut, \GeV}{The jet rates distributions obtained with SIScone ($R=1.0,O=0.75$) jet clustering algorithm for $\sqrt{s}= 161\GeV$. The first uncertainty is statistical and the second is systematical.}
\TABGantiktonesixoneJETRall{$y$ cut}{The jet rates distributions obtained with anti-$k_{T}$ jet clustering algorithm for $\sqrt{s}= 161\GeV$. The first uncertainty is statistical and the second is systematical.}
