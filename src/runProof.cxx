  ...
  int main(int argc ,char** argv)
{
    ...
    fMI.insert(std::pair<std::string,std::string>("NUMBER",(int)  (e_config->GetValue(CONF+".NUMBER",100000000)));
    ...
    if (argc>1)      fMS.insert(std::pair<std::string,std::string>("OPTION",  argv[2]));
