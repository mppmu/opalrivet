...
int main(int argc, char** argv)
{
  ...
  KEY: TH1F	h3118350;1	1-T	Parton	PYTHIA	(Z/g)*	sptsta moments 
					...
					*/
                    ...
                    replace_all(name,"h98600","H_manipcorrected_"+std::string(argv[2])+"_205GeV_");
                    ...
                    replace_all(name,"h88600","H_manipcorrected_"+std::string(argv[2])+"_196GeV_");
                    replace_all(name,"h78600","H_manipcorrected_"+std::string(argv[2])+"_192GeV_");
                    replace_all(name,"h68600","H_manipcorrected_"+std::string(argv[2])+"_189GeV_");
                    replace_all(name,"h58600","H_manipcorrected_"+std::string(argv[2])+"_183GeV_");
                    replace_all(name,"h48600","H_manipcorrected_"+std::string(argv[2])+"_172GeV_");

                    replace_all(name,"h38600","H_manipcorrected_"+std::string(argv[2])+"_161GeV_");
                    replace_all(name,"h30000","H_manipdata_"+std::string(argv[2])+"_161GeV_");
                    replace_all(name,"h31100","H_manipmcsignal_"+std::string(argv[2])+"_161GeV_");
                    replace_all(name,"h31180","H_manipmcsignaltrue_"+std::string(argv[2])+"_161GeV_"); //PARTON!
                    //h31183
                    //replace_all(name,"h3310","H_manipmcbackgr_"+std::string(argv[2])+"_161GeV_");

                    replace_all(name,"h28600","H_manipcorrected_"+std::string(argv[2])+"_136GeV_");

                    replace_all(name,"h20000","H_manipcorrected_"+std::string(argv[2])+"_130GeV_");

                    replace_all(name,"h18600","H_manipcorrected_"+std::string(argv[2])+"_91GeV_");
