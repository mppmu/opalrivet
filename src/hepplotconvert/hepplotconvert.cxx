...
int main(int argc, char** argv)
{
    ...
    std::map<std::string,formats> format_map;
     format_map.insert(std::pair<std::string,formats> ( "yoda", yoda ));
      format_map.insert(std::pair<std::string,formats> ( "flat", flat ));
      format_map.insert(std::pair<std::string,formats> ( "aida", aida ));
