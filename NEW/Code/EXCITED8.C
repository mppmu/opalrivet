...
#ifdef USE_DURHAM    
    OPALObs(this,Form("%s_durham_%sGeV_",TYPE,ENERGY));
#endif
#ifdef USE_JADE
    OPALObs(this,Form("%s_jade_%sGeV_",TYPE,ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("%s_antikt_%sGeV_",TYPE,ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("%s_cambridge_%sGeV_",TYPE,ENERGY));
#endif


#ifdef MC
#ifdef USE_DURHAM    
    OPALObs(this,Form("true_durham_%sGeV_",ENERGY));
#endif
#ifdef USE_JADE
    OPALObs(this,Form("true_jade_%sGeV_",ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("true_antikt_%sGeV_",ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("true_cambridge_%sGeV_",ENERGY));
#endif
#endif
...
#ifdef MC
#ifdef USE_DURHAM    
    OPALObs(this,Form("acceptance_durham_%sGeV_",ENERGY));
#endif
#ifdef USE_JADE
    OPALObs(this,Form("acceptance_jade_%sGeV_",ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("acceptance_antikt_%sGeV_",ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("acceptance_cambridge_%sGeV_",ENERGY));
#endif
...
#ifdef USE_DURHAM    
    OPALObs(this,Form("corrected_durham_%sGeV_",ENERGY));
#endif
#ifdef USE_JADE
    OPALObs(this,Form("corrected_jade_%sGeV_",ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("corrected_antikt_%sGeV_",ENERGY));
#endif

#ifdef USE_ANTIKT
    OPALObs(this,Form("corrected_cambridge_%sGeV_",ENERGY));
#endif
